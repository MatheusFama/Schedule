...
namespace Schedule.Services
{
    ...
    {
        AccountAuthenticateResponse Authenticate(AccountAuthenticateRequest model, string ipAddress);
        AccountAuthenticateResponse RefreshToken(string token, string ipAddress);
        void RevokeToken(string token, string ipAddress);
        void Register(AccountRegisterRequest model, string origin);
        void VerifyEmail(string token);
        void ForgotPassword(AccountForgotPasswordRequest model, string origin);
        void ValidateResetToken(AccountValidateResetTokenRequest model);
        void ResetPassword(AccountResetPasswordRequest model);
    ...
    public class AccountService : IAccountService
    {
        ...
        public AccountAuthenticateResponse Authenticate(AccountAuthenticateRequest model, string ipAddress)
        {
            ...
            var response = _mapper.Map<AccountAuthenticateResponse>(account);
            response.JwtToken = jwtToken;
            response.RefreshToken = refreshToken.Token;
            return response;
        }

        public AccountAuthenticateResponse RefreshToken(string token, string ipAddress)
        {
        ...
        public void Register(AccountRegisterRequest model, string origin)
        {
            // validate
        ...
        public void ForgotPassword(AccountForgotPasswordRequest model, string origin)
        {
            var account = _context.Accounts.SingleOrDefault(x => x.Email == model.Email);
        ...
        public void ValidateResetToken(AccountValidateResetTokenRequest model)
        {
        ...
        public void ResetPassword(AccountResetPasswordRequest model)
        {
            var account = _context.Accounts.SingleOrDefault(x =>
                x.ResetToken == model.Token &&
                x.ResetTokenExpires > DateTime.UtcNow);
